<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="BTL_LTWEB_WEBSITE_READSTORY.login" %>
...
<body>
    ...
    <form method="post" runat="server" onsubmit="return check()">
        ...
        <button type="submit" value="Đăng nhập" runat="server" onclick="Login();">Đăng nhập</button>
        <div class="social">
          <div class="go">
              <a href="forgot.aspx">Quên mật khẩu</a>
          </div>
          <div class="fb">
              <a href="register.aspx">Đăng kí</a>
          </div>
        </div>
    </form>
